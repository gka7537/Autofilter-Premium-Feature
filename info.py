...
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 3600))    # Cache time in seconds (default: 5 minutes)
...
PORT = int(environ.get("PORT", "10000"))  # Port for the web server (default: 10000)
